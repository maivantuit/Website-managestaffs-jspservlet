...
public final class viewliststaffofeachdepartmentdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <li><a href=\"#\">Xem nhật ký của bạn</a></li>\t\t\t\t\t\t\n");
      out.write("            </ul>\n");
      out.write("        </li>\n");
...
if(s !=null){
      ...
      out.write("            <h2 class=\"account-in\">View list staff</h2>                \n");
      ...
      out.write("                    <th class=\"data\">Tên NV</th>\n");
      out.write("                    <th class=\"data\">Mã DV</th>\n");
      out.write("                    <th class=\"data\">Chức vụ</th>                            \n");
      out.write("                    <th class=\"data\">Ngày cập nhật</th>                                                        \n");
      out.write("                    <th class=\"data\">Ghi chú</th>                                                                                                                                   \n");
      ...
      out.print( s1.getMotStaff(Integer.parseInt(c.getMaNV())).getHo()+" - "+s1.getMotStaff(Integer.parseInt(c.getMaNV())).getTen());
      out.write("</td>  \n");
      out.write("                    <td class=\"data\">");
      out.print( c.getMaDV());
      out.write("</td>  \n");
      out.write("                    <td class=\"data\">");
      out.print( c.getChucVu());
      out.write("</td>\n");
      out.write("                    <td class=\"data\">");
      out.print( c.getCapNhat());
      out.write("</td>                \n");
      out.write("                    <td class=\"data\">");
      out.print( c.getGhiChu());
      out.write("</td>                    \n");
      out.write("                    <td class=\"data\" width=\"180px\">\n");
      out.write("                        <center>                          \n");
      out.write("                            <a href=\"#\">Cập nhật</a>\n");
      out.write("                            &nbsp; | &nbsp;\n");
      out.write("                            <a href=\"#\">Khóa</a>                            \n");
      out.write("                        </center>   \n");
      out.write("                    </td>\n");
      out.write("                </tr>  \n");
      out.write("                ");
